 ...
 * <p>
 *  Note: the implementation here is a bit trivial because most of the heavy lifting is done within the zener.Command enum.
 */
public class Parser {
    /**
     ...
     * @return the output zener.Command, null if fail
     */
     ...
     * This function does not care about parameter correctness; that is handled by the zener.Command enum.
     *
     * @param raw the raw input string
